        ...
        <header className={cn(
            ...
            <div className="flex items-center gap-8">
                ...
                <Link href="/" className="flex items-center gap-2 group">
                    <div className="w-8 h-8 rounded-lg bg-orange-500 flex items-center justify-center text-white shadow-lg shadow-orange-500/20 group-hover:scale-105 transition-transform">
                        <ShoppingBag className="w-5 h-5" />
                    </div>
                    <span className="text-sm sm:text-lg font-black tracking-tighter text-white uppercase italic">
                        Bhogal <span className="text-orange-500">Auto</span>
                    </span>
                </Link>
